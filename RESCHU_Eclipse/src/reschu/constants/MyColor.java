...
public class MyColor {
    ...
    final static public Color COLOR_ZOOM_INDICATOR		  = new Color(51,255,51,255);
    ...
    final static public Color COLOR_TARGET_VACANT		  = new Color(255, 128, 128, 150);
    final static public Color COLOR_TARGET_OCCUPIED 	  = new Color(240, 10, 10, 150);
    ...
    final static public Color COLOR_TARGET_INVISIBLE      = new Color(130,130,130,150);
    ...
    final static public Color COLOR_VEHICLE_NOTIFIED	  = new Color(255,128,0,255);
}